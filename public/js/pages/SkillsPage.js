...
import { SkillsChart } from '../components/charts/SkillsChart.js';
...
export class SkillsPage {
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between items-center h-16">
                        <div class="flex items-center">
                            ...
                            <h1 class="text-xl font-semibold text-secondary-900">Skills</h1>
                        </div>
                        <button
                            id="logout-button"
    ...
    renderNavigation() {
        ...
        const navigation = new Navigation('skills');
        navigation.show(navContainer);
    }

    renderChart() {
        const chartContainer = this.element.querySelector('#chart-container');
        const skillsChart = new SkillsChart(this.userData.skill);
        skillsChart.show(chartContainer);
    }
